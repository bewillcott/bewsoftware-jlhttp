 ...
 * @version 2.5.2
 *
 * @deprecated Replaced by revised version
 */
@Deprecated
public class HTTPServer1 {
     ...
     * Http Server version.
     * <p>
     * Added by: Bradley Willcott (2020/12/13)
     */
    ...
    public static void main(String[] args) throws URISyntaxException, InterruptedException {
        ...
        try
        {
            server = new HTTPServer1(DEFAULT_PORT_RANGE[0]);
    ...
    public final class Request {
        ...
        public VirtualHost getVirtualHost() {
            return host != null ? host
                   : (host = HTTPServer1.this.getVirtualHost(getBaseURL().getHost())) != null ? host
                     : (host = HTTPServer1.this.getVirtualHost(null));
        }
    ...
    protected class SocketHandlerThread extends Thread {
        ...
        public void run() {
            ...
            try
            {
                ServerSocket serverSocket = HTTPServer1.this.serv; // keep local to avoid NPE when stopped
